...
const convertParam_1 = __importDefault(require("./middleware/convertParam"));
const dataParser_1 = __importDefault(require("./middleware/dataParser"));
const decrypt_1 = __importDefault(require("./middleware/decrypt"));
const app = new koa_1.default();
app.use(koa2_cors_1.default());
app.use(koa_convert_1.default(koa_logger_1.default()));
app.use(koa_bodyparser_1.default());
app.use(convertParam_1.default);
app.use(decrypt_1.default);
app.use(dataParser_1.default);
